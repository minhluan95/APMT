...
public partial class CP_SPMEntities1 : DbContext
{
    public CP_SPMEntities1()
        : base("name=CP_SPMEntities1")
    {
    ...
    public virtual DbSet<APMT_Activity_to_Activity> APMT_Activity_to_Activity { get; set; }

    public virtual DbSet<APMT_Activity_Type> APMT_Activity_Type { get; set; }
    ...
    public virtual DbSet<APMT_Project_User> APMT_Project_User { get; set; }

    public virtual DbSet<APMT_Task> APMT_Task { get; set; }
